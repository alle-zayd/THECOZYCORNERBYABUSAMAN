    ...
    <section>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-white p-4 rounded shadow">
          ...
          alt="Deep Dive to Modern CSS with Tailwind" 
          width={300} height={400} />
          <h3 className="mt-3 font-medium">Modern CSS with Tailwind</h3>
        </div>

        <div className="bg-white p-4 rounded shadow">
          <Image src="/images/book2.png" 
          alt="An Introduction to Next.js" 
          width={300} 
          height={400} />
        ...
        <div className="bg-white p-4 rounded shadow">
          ...
          alt="Carol S. Dweck's Mindset: The Book About Growth and Fixed Mindsets" 
          width={300}
           height={400} />
